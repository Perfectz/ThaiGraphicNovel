...
export type ChapterCharacterReaction =
  | 'smile'
  | 'explaining'
  | 'surprised'
  | 'worried'
...
const chapterCharacters: ChapterCharacterDefinition[] = [
  {
    ...
    className: 'left-[-4rem] h-[min(53dvh,32rem)] sm:left-[4vw] sm:h-[min(59dvh,37rem)] lg:left-[9vw]',
  },
  {
    id: 'front-desk-clerk',
    ...
    className: 'left-[-3.5rem] h-[min(53dvh,32rem)] sm:left-[4vw] sm:h-[min(59dvh,37rem)] lg:left-[9vw]',
  },
  {
