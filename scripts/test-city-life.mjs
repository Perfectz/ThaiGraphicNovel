...
try{
 ...
 await page.getByRole('button',{name:'Battle practice',exact:true}).click();await page.getByRole('button',{name:/^✦ Word arts/}).waitFor();await page.screenshot({path:`${out}/phone-battle.png`});await page.getByRole('button',{name:'Retreat',exact:true}).click();report.battle=true;
